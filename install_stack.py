...
def main() -> int:
    ...
    save_env_file(
        repo_env_file,
        repo_env,
        comment_header="# Token Telemetry Config (Autogenerated / Updated by install_stack.py)"
    )
    ...
    for HUB in hubs_to_install:
        ...
        print("Deploying local token telemetry files...")
    ...
    run_db = prompt_input("Would you like to start the Token Telemetry dashboard in the background? (y/n)", default="y")
