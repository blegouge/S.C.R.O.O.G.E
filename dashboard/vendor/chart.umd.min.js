...
!(function (t, e) {
  ...
  function Kt(t) {
    ...
    return (
      Array.isArray(t)
        ? t.length >= 3 &&
          ((e = { r: t[0], g: t[1], b: t[2], a: 255 }), t.length > 3 && (e.a = Mt(t[3])))
  ...
  class Zt {
    ...
    rgbString() {
      return this._valid
        ? (t = this._rgb) &&
            (t.a < 255 ? `rgba(${t.r}, ${t.g}, ${t.b}, ${wt(t.a)})` : `rgb(${t.r}, ${t.g}, ${t.b})`)
        : void 0;
      var t;
    }
    hexString() {
  ...
  const Ue = (t, e) => (t ? t + w(e) : e),
    Xe = (t, e) =>
      o(e) && 'adapters' !== t && (null === Object.getPrototypeOf(e) || e.constructor === Object);
  function qe(t, e, i) {
        ...
        for (i = 0, s = t.length; i < s; ++i)
          ((a = o),
            ...
            o &&
              ...
              r &&
                ((n.cp2x = li(n.cp2x, e.left, e.right)), (n.cp2y = li(n.cp2y, e.top, e.bottom)))));
      })(t, i);
  }
  const ci = (t) => 0 === t || 1 === t,
    ...
    ui = (t, e, i) => Math.pow(2, -10 * t) * Math.sin(((t - e) * O) / i) + 1,
      ...
      easeInOutBounce: (t) =>
        t < 0.5 ? 0.5 * fi.easeInBounce(2 * t) : 0.5 * fi.easeOutBounce(2 * t - 1) + 0.5,
    };
  function gi(t, e, i, s) {
      ...
      ((m = e[t % a]),
        m.skip ||
          ...
          p !== b &&
            ...
            null !== _ &&
              v() &&
              (g.push(Ei({ start: _, end: t, loop: u, count: a, style: f })), (_ = null)),
            (i = t),
            (b = p))));
  ...
  function ks(t) {
    return !fe() || ('undefined' != typeof OffscreenCanvas && t instanceof OffscreenCanvas)
      ? ls
      : ws;
  }
  ...
  class Ns {
    ...
    applyStack(t, e, i) {
      const s = this.chart,
        n = this._cachedMeta,
        o = e[t.axis];
      return Ls({ keys: Ts(s, !0), values: e._stacks[t.axis]._visualValues }, o, n.index, {
        mode: i,
      });
    }
    ...
    getMinMax(t, e) {
      const i = this._cachedMeta,
        ...
        l = ((t, e, i) => t && !e.hidden && e._stacked && { keys: Ts(i, !0), values: null })(
          e,
          i,
          this.chart
        ),
  ...
  class Js extends Hs {
    ...
    getContext(t) {
      ...
      return (
        this.$context ||
        (this.$context = Ci(this.chart.getContext(), { scale: this, type: 'scale' }))
      );
    }
    _tickSize() {
    ...
    _computeGridLineItems(t) {
      ...
      if ('top' === a)
        ...
        ((x = b(this.top)), (D = t.top), (O = b(t.bottom) - m), (w = x + m), (S = this.top + u));
      else if ('left' === a)
        ((x = b(this.right)),
          (M = this.right - u),
          (k = x - m),
        ...
        ((x = b(this.left)), (P = t.left), (C = b(t.right) - m), (M = x + m), (k = this.left + u));
      else if ('x' === e) {
        ...
        ? (function (t, { plugins: e, localIds: i }, s, n) {
            ...
            for (const r of e) {
              const e = r.id,
                l = nn(s[e], n);
              null !== l &&
                o.push({ plugin: r, options: on(t.config, { plugin: r, local: i[e] }, l, a) });
            }
            return o;
          })(t, n, s, e)
        : [];
      ...
      (e &&
        ...
        u(n, (e) => {
          ...
          if (o in i && i[o].type === r) h = i[o];
            ...
            ((h = new (en.getScale(r))({ id: o, type: r, ctx: this.ctx, chart: this })),
              (i[h.id] = h));
          }
          h.init(n, t);
        }),
  ...
  function Wn(t, e, i, s) {
    ...
    return (
      s
        ? ((a = i), (t = Nn((t = (n = t) === (o = e) ? a : n === a ? o : n), i, e)))
        : (t = Nn(t, e, i)),
      t
    );
  }
  ...
  var Yn = Object.freeze({
    ...
    BarController: class extends Ns {
      ...
      _calculateBarValuePixels(t) {
        ...
        if (
          ((d = this.chart.getDataVisibility(t) ? e.getPixelForValue(g + p) : b),
          (u = d - b),
          Math.abs(u) < a)
        ) {
          ((u =
          ...
          ((b = Math.max(Math.min(b, h), o)),
            ...
            i &&
              !c &&
              (l._stacks[e.axis]._visualValues[n] = e.getValueForPixel(d) - e.getValueForPixel(b)));
        }
  ...
  function Fo(t, e) {
    ...
    return (
      ...
      null === l
        ...
        : (o &&
            (l =
              'week' !== o || (!N(r) && !0 !== r) ? i.startOf(l, o) : i.startOf(l, 'isoWeek', r)),
          +l)
    );
  }
  function Vo(t, e, i, s) {
  ...
  var Go = {
    ...
    beforeLayout(t, e, i) {
      ...
      if (
        !i.forceOverride &&
        (Ko(s) || ((a = n) && (a.borderColor || a.backgroundColor)) || (o && Ko(o)))
      )
        return;
      var a;
      const r = qo(t);
  ...
  class xa extends Hs {
    ...
    adjustHitBoxes() {
      ...
      if (this.isHorizontal()) {
        ...
        for (const r of e)
          (n !== r.row &&
            ((n = r.row), (a = ft(i, this.left + s, this.right - this.lineWidths[n]))),
            (r.top += this.top + t + s),
        ...
        for (const r of e)
          (r.col !== n &&
            ((n = r.col), (a = ft(i, this.top + t + s, this.bottom - this.columnSizes[n].height))),
            (r.top = a),
            (r.left += this.left + s),
    ...
    drawTitle() {
      ...
      if (this.isHorizontal())
        ...
        h =
          l +
          ft(t.align, this.top, this.bottom - e - t.labels.padding - this._computeTitleHeight());
      }
      const u = ft(a, c, c + d);
